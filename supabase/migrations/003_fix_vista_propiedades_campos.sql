-- ============================================
-- ACTUALIZAR VISTA vw_propiedades_publicas
-- Corrige nombres de columnas para coincidir con el frontend
-- ============================================
...
SELECT 
  ...
  -- Datos del propietario desde perfiles (NOMBRES CORREGIDOS PARA FRONTEND)
  ...
  p.verificado as propietario_verificado,
  p.tipo_cuenta as propietario_tipo,
  p.empresa_nombre as propietario_empresa,
  p.nivel_confianza,
...
-- Comment
COMMENT ON VIEW vw_propiedades_publicas IS 'Vista pública de propiedades activas con imágenes y datos relacionados. Incluye campos corregidos para el frontend (propietario_foto, propietario_verificado, propietario_tipo, propietario_empresa).';
